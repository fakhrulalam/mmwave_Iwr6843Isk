...
from radar_application import RadarApplication
import threading
    ...
    try:
        ...
        def safe_update():
            try:
                ...
                window.command_textbox.appendPlainText(
                    "Restart => 1): Press on 'Stop Device' or 'Sensor's NRST' Button, "
                    "2): Select on desired plot, 3): Click on 'Send Configuration'."
                )
